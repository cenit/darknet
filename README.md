...
- [Yolo v4, v3 and v2 for Windows and Linux](#yolo-v4-v3-and-v2-for-windows-and-linux)
  - [(neural networks for object detection)](#neural-networks-for-object-detection)
    - [YOLOv7: Trainable bag-of-freebies sets new state-of-the-art for real-time object detectors](#yolov7-trainable-bag-of-freebies-sets-new-state-of-the-art-for-real-time-object-detectors)
...
Install: `Cmake`, `CUDA`, `cuDNN` [How to install dependencies](#requirements-for-windows-linux-and-macos)
